  ...
  if (!profile) {
    return (
      <SafeAreaView className="flex-1 items-center justify-center bg-[#fcFAF8] dark:bg-slate-950" edges={['top']}>
        ...
        <TouchableOpacity onPress={signOut} className="mt-4 p-3 bg-red-50 rounded-xl dark:bg-red-950/20">
      ...
      <ScrollView
        ...
        <View className="flex-row items-center justify-end px-6 pt-4">
          <TouchableOpacity 
            ...
            className="h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-slate-900 shadow-sm border border-gray-50 dark:border-slate-800">
        ...
        <View className="mt-6 items-center px-4">
          ...
          <View className="relative mb-6">
            <View 
              ...
              style={{ borderColor: profile.role === 'admin' ? '#FFD700' : (isDarkMode ? '#0f172a' : '#fcFAF8') }}>
              {avatarUploading ? (
        ...
        <View className="mb-12 px-6">
          ...
          {timeline.length === 0 ? (
            <View className="items-center rounded-3xl border-2 border-dashed border-gray-200 dark:border-slate-800 py-10">
              <Feather name="clock" size={28} color={isDarkMode ? '#334155' : "#d1d5db"} />
              <Text className="mt-3 text-[13px] font-semibold text-gray-300 dark:text-slate-600">No life events yet</Text>
            </View>
          ) : (
            ...
            <ScrollView
              ...
              {connections.map((conn, idx) => (
                <TouchableOpacity
                  ...
                  <View className="mb-3 h-[80px] w-[80px] overflow-hidden rounded-full border-[3px] border-white dark:border-slate-800 bg-gray-100 dark:bg-slate-900">
                  ...
                  <Text className="text-[13px] font-bold text-gray-900 dark:text-white text-center" numberOfLines={1}>
